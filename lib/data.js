...
export const projects = [
  ...
  {
  id: 6,
  title: "Battery Energy Storage Management Platform (BESS)",
  description:
    "Built a production-style backend platform for Battery Energy Storage Systems using FastAPI. Implemented JWT authentication, battery management APIs, telemetry storage with TimescaleDB, Redis caching, and Dockerised deployment following a modular architecture.",
  technologies: [
    "Python",
    "FastAPI",
    "PostgreSQL",
